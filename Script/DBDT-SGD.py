#  -*-  coding: UTF-8  -*-
# This is a Python script for DBDT-SGD package. We illustrate the overall structure of DBDT in over paper, and summary the optimization
# procedure using SGD which we call DBDT-SGD, DBDT-SGD has a significant effect on balanced data.
